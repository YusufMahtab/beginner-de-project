...
from data catalog 
database 'spectrumdb' 
iam_role 'arn:aws:iam::005874979056:role/myFirstIAMRole'
...
stored as textfile
location 's3://bengalis-first-bucket/user_purchase/stage/'
...
STORED AS PARQUET
LOCATION 's3://bengalis-first-bucket/movie_review/stage/';
